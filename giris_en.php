...
<html dir="ltr" lang="en" xml:lang="en">
  <head>
    <title>Log in to the site | Bursa Teknik Üniversitesi Öğrenme Ortamı</title>
    <link
      rel="shortcut icon"
    ...
    <meta
      name="keywords"
      content="moodle, Log in to the site | Bursa Teknik Üniversitesi Öğrenme Ortamı"
    />
    <link
      rel="stylesheet"
      type="text/css"
  ...
  <body
    id="page-login-index"
    class="format-site path-login chrome dir-ltr lang-en yui-skin-sam yui3-skin-sam ekampus-btu-edu-tr pagelayout-login course-1 context-1 notloggedin theme moove-login"
  >
    <div
                      ...
                      <div class="col">
                        <div id="loginlogo" class="login-logo">
                          ...
                          <h1 class="login-heading sr-only">
                            Log in to Bursa Teknik Üniversitesi
                          </h1>
                        </div>
                        ...
                        >
                          <input
                            type="hidden"
                            name="logintoken"
                            value="kQDXkrVbsJCJqF5aCpYdL37MDrke9UHj"
                          />
    ...
    <div class="d-none">
      <a
        class="mobilelink"
        href="https://download.moodle.org/mobile?version=2024042203&amp;lang=en&amp;iosappid=633359593&amp;androidappid=com.moodle.moodlemobile&amp;siteurl=https%3A%2F%2Fekampus.btu.edu.tr"
      ...
      <script src="https://ekampus.btu.edu.tr/lib/javascript.php/1736238774/lib/requirejs/require.min.js"></script>
      <script>
        //<![CDATA[
        ...
        M.str = {
          ...
          repository: {
            ...
            fileexistsdialog_filemanager:
              "A file with that name has already been attached",
          ...
          admin: {
            confirmdeletecomments:
              "Are you sure you want to delete the selected comment(s)?",
      ...
      <script>
        ...
        (function () {
          ...
          M.util.js_pending("random67e2e0099f3814");
          Y.on("domready", function () {
            M.util.js_complete("init");
            M.util.js_complete("random67e2e0099f3814");
          });
        })();
        //]]>
      </script>
